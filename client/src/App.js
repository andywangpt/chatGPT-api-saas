            ...
            <div id="cardBody" className="card-body rounded-bottom mx-0">
                  ...
                  <form onSubmit={handleSubmit}>
					...
					{response ? (
                     ...
                     <img src={robotPreparesDinner} alt="chowGPT" className="card-img-top" />

				
								<pre className="card-text mx-auto mb-0">
									Here are some dinner ideas:{response}
								</pre>
				
							
                     <button className="btn btn-sm btn-dark m-1" onClick={handleReset} type="button">
								Try Again!
							</button>
